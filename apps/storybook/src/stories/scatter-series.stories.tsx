...
import { Chart, ScatterSeries, CartesianGrid, XAxis, YAxis, Tooltip, Legend } from 'viskit-react';
 ...
 * import { ScatterSeries, CartesianGrid, XAxis, YAxis, Tooltip } from 'viskit-react';
 * ```
 *
