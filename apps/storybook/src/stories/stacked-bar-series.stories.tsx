...
import { Chart, StackedBarSeries, CartesianGrid, XAxis, YAxis, Tooltip, Legend } from 'viskit-react';
 ...
 * import { StackedBarSeries, CartesianGrid, XAxis, YAxis, Tooltip } from 'viskit-react';
 * ```
 *
